...
import { UserAwards as Schema } from 'src/schemas';
import { ApiBearerAuth, ApiTags } from '@nestjs/swagger';
import { UserAwardsService as Service } from 'src/services/userAwards.service';

@ApiBearerAuth()
@ApiTags('UserAwards')
@Controller('userawards')
export class UserAwardsController {
